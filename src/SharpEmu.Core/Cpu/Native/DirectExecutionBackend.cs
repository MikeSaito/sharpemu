...
#pragma warning restore CS0649
	...
	// runtime frees trampolines or guest memory.
	...
	private unsafe void PatchTlsPatterns()
	{
		...
		// (250+ MiB) place TLS loads far past a fixed entry+NMiB window. Astro Bot,
		// for example, has an FS:[0] TLS load near +0x70A0000.
